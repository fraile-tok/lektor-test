...
def abstract_pull():
    ...
    file_name = input ("Enter filename (without .csv): ")
    ...
    full_file_name = "abstract_downloading/" + file_name + "_abstracts.csv"
    partials_file_name = "abstract_downloading/partial_" + file_name + "_abstracts.csv"

    # write all_abstracts to a csv file for downstream data analysis
    with open(full_file_name, "wt") as abstracts_file, open (partials_file_name, "wt") as partial_abstracts:
...
def abstract_csv_to_txt():
    file_name = input ("Enter your desired name for your file (without .txt): ")
    file_query = "articles/" + file_name + ".txt"
    csv_name = input ("Enter the name of the prefix of the abstracts csv (for instance, prefix for prefix_abstracs.csv): ")
    csv_query = "abstracts_downloading/" + csv_name + "_abstracts.csv"
    ...
    with open(file_query,"wt") as abstracts_txt:
        with open (csv_query, "r") as abstracts_csv:
            reader = csv.DictReader(abstracts_csv) # read rows into a dictionary format
